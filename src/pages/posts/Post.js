            ...
            <Card.Body>
                ...
                <div className={`${styles.PostBar} ${appStyles.BoxShadow}`}>
                    ...
                    <div className={styles.Comments}>
                        <Link
                            to={`/posts/${id}`}
                            aria-labelledby="Click to view comments"
                        >
                    ...
                    {recipes.results.length && currentUser ? (
                        <Tooltip
                            title="Click to view the recipe"
                            placement="bottom"
                            arrow
                        >
                            <div
                        ...
                        <Tooltip
                            title="Login to view the recipe"
                            placement="bottom"
                            arrow
                        >
                            <Link
                                to={"/signin"}
                                aria-labelledby="Click to sign in"
                            >
